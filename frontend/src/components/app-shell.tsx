          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" render={<Link href="/home" />}>
                <div className="flex aspect-square size-8 items-center justify-center overflow-hidden rounded-lg bg-muted ring-1 ring-foreground/10">
                  <Image
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Code Royale</span>
                  <span className="truncate text-xs text-muted-foreground">Compete. Climb. Win.</span>
                </div>
              </SidebarMenuButton>
            </SidebarMenuItem>
          </SidebarMenu>
        ...
        <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b border-border bg-background/80 px-4 backdrop-blur-xl sm:px-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger
                render={
                  <Button variant="outline" size="icon" aria-label="Friend requests">
                    <Bell />
        ...
        {onlineToasts.length > 0 && (
          <div className="pointer-events-none fixed bottom-6 right-6 z-50 flex w-full max-w-sm flex-col gap-2">
            {onlineToasts.map((toast) => (
              <div
                key={toast.id}
                className="flex items-center gap-2 rounded-lg border border-border bg-card px-4 py-3 text-sm font-medium text-card-foreground shadow-lg"
              >
