      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-cr-border bg-cr-bg-secondary p-8">
          <div className="mb-8 text-center">
            <h1 className="text-2xl font-bold text-cr-fg">Welcome back</h1>
            <p className="mt-2 text-sm text-cr-fg-muted">
              Sign in to continue to Code Royale
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-sm font-medium text-cr-fg">
                  Password
                </label>
                <Link
                  href="#"
                  className="text-xs text-cr-accent hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="remember" className="text-sm text-cr-fg-muted">
                Remember me
              </label>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-cr-fg-muted">
            ...
            <Link href="/auth/signup" className="text-cr-accent hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
